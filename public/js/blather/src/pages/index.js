...
class SocialMediaPage extends Component {
    ...
    handleItemClick = (e, { name }) => {
        ...
        this.props.history.push(
            `/pages/${this.state.network}/${this.state.id}/${name}`
        );
    };
                            ...
                            <DimmerMsg
                                btn={
                                    <Button
                                        ...
                                        onClick={() =>
                                            props.history.push(
                                                `/settings/${props.network}`
                                            )
                                        }
                                    >
                                        <Icon name={props.network} /> Link your{" "}
                                        {props.network}
                                    </Button>
                                }
                                msg={`Link your ${
                                    props.network
                                } to start calling ${props.name} out`}
                                props={props}
                            />
                        </Dimmer.Dimmable>
                    );
