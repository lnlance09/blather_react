...
class SettingsPage extends Component {
    constructor(props) {
        ...
        if(activeItem === 'twitter' && parsed.oauth_token && parsed.oauth_verifier && !currentState.user.data.linkedTwitter) {
            ...
            if(activeItem === 'basic') {
                ...
                return (
                    <div className='changePasswordBox'>
                        ...
                        <p><Icon name='clock' /> Joined <Moment date={joinDate} fromNow interval={60000} /></p>
                        <Header>Change Password</Header>
                        <Form
                            error={this.props.passwordError}
                            loading={loading && !this.props.passwordChangeSuccessful && !this.props.passwordError}
                        ...
                        >
                            ...
                            <Message
                                error
                                content={this.props.passwordErrorMsg}
                            />
                            <Message
                                content='Your password has been successfully changed'
                                success
                            />
                            <Button className='passwordSubmit' fluid type='submit'>Submit</Button>
                        </Form>
                    </div>
                )
            }
                ...
                return (
                    <div>
                        {this.props.data.linkedTwitter ? (
                            <div>
                                <p className='firstParagraph'>
                                    You linked your Twitter account <Moment date={twitterDate} fromNow interval={60000} />
                                </p>
                ...
                return (
                    <div>
                        {this.props.data.linkedYoutube ? (
                            <div>
                                <p className='firstParagraph'>
                                    You linked your YouTube account <Moment date={youtubeDate} fromNow interval={60000} />
                                </p>
