...
export const GET_DISCUSSION_CONVERSATION =
    "discussion:GET_DISCUSSION_COVERSATION";
...
export const SUBMIT_DISCUSSION_CONVERSATION =
    "discussion:SUBMIT_DISCUSSION_CONVERSATION";
export const SUBMIT_FALLACY_CONVERSATION =
    "fallacy:SUBMIT_FALLACY_CONVERSATION";
