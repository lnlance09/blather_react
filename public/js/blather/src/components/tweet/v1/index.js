                    ...
                    <Card fluid>
                        ...
                        <Card.Content>
                            ...
                            <Card.Description className='tweetUserTweet'>
                                ...
                                >
                                    { this.props.retweeted_status ? this.props.retweeted_status.full_text : this.props.full_text }
                                </Linkify>
...
Tweet.propTypes = {
    ...
    stats: PropTypes.shape({
        favorite_count: PropTypes.oneOfType([
            PropTypes.number,
            PropTypes.string
        ]),
        retweet_count: PropTypes.oneOfType([
            PropTypes.number,
            PropTypes.string,
        ])
    }),
