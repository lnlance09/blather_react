...
CREATE TABLE `tags` (
  ...
  CONSTRAINT `tags_ibfk_1` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`)
...
-- Create syntax for TABLE 'tag_versions'
CREATE TABLE `tag_versions` (
  ...
  CONSTRAINT `tag_versions_ibfk_1` FOREIGN KEY (`tag_id`) REFERENCES `tags` (`id`),
  CONSTRAINT `tag_versions_ibfk_2` FOREIGN KEY (`updated_by`) REFERENCES `users` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8;
