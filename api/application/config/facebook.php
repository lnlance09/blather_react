...
$config['facebook_app_id']              = 498572440350555;
$config['facebook_app_secret']          = '5c8ad8b23b664b383b91c026d9e07b8a';
$config['facebook_login_type']          = 'web';
$config['facebook_login_redirect_url']  = 'fb/redirect';
$config['facebook_logout_redirect_url'] = 'home/logout';
$config['facebook_permissions']         = ['public_profile', 'user_posts', 'email', 'user_friends'];
