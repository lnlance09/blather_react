<?php 
    class FallaciesModel extends CI_Model {
        ...
        public function assignFallacy($assigned_by, $comment_id, $explanation, $fallacy_id, $media_id, $network, $page_id, $startTime, $title, $contradiction = null) {
